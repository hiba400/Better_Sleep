      ...
      <div className="w-full max-w-md px-4">
        <div className="card-premium space-y-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-muted-foreground">Sign in to your SleepBetter account</p>
          </div>
          ...
          <div className="text-center text-sm text-muted-foreground">
            ...
            <Link href="/auth/signup" className="text-accent font-semibold hover:text-accent/80 transition">
              Create one here
            </Link>
          </div>
        </div>
